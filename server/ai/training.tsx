...
1. **MAXIMUM DATA GENERATION:** Generate AT LEAST 15-25 distinct intents from the provided content. Break down every topic, subtopic, and concept into separate intents. Be extremely thorough and comprehensive.
...
7. **COMPREHENSIVE COVERAGE:** Extract EVERY possible topic, subtopic, question, and concept from the input text. 
...
9. **DETAILED BREAKDOWN:** For each major topic, create multiple specific intents:
   - General overview intent
   - Specific details intent
   - Requirements intent
   - Process intent
   - Contact intent
   - FAQ intent
